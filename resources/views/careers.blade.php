                    ...
                    <div class="col-md-8">
                        ...
                        <div class="expand-box">
                            <div class="inner">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="img/misc/pic%20(11).jpg" alt="" class="pull-left">
                                        <h4>Truck Driver</h4>
                                        Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem 
                                    </div>
                                    <div class="col-md-3">
                                        <div class="divider"></div>
                                        <strong>Business Sector:</strong><br>
                                        Warehousing
                                    </div>
                                    <div class="col-md-3">
                                        <div class="divider"></div>
                                        <strong>End Date:</strong><br>
                                        <span class="id-color">Dec 30 2015</span>
                                    </div>
                            ...
                            <a href="#" class="btn-custom btn-fullwidth">Apply Now</a>
                        ...
                        <div class="expand-box">
                            <div class="inner">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="img/misc/pic%20(11).jpg" alt="" class="pull-left">
                                        <h4>Customer Account Controller</h4>
                                        Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem 
                                    </div>
                                    <div class="col-md-3">
                                        <div class="divider"></div>
