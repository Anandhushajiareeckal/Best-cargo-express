    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <img src="img/about/company/small-14.jpg" alt="" class="pull-right"><p><strong><i>Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus</i></strong></p>
                <p>
                ...
                <ul class="single-carousel-arrow-nav">
                    <li>
                        <div class="inner">
                            <img src="img/about/company/director-1.jpg" alt="" class="pull-left">
                            <div class="text">
                                <span class="name">John Rukman</span>
                                <span class="position">Founder &amp; Vince President</span>
                                <p>
                                    Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae
                                </p>
                            </div>
                    ...
                    <li>
                        <div class="inner">
                            <img src="img/about/company/team-2.jpg" alt="" class="pull-left">
                            <div class="text">
                                <span class="name">John Rukman</span>
                                <span class="position">Founder &amp; Vince President</span>
                                <p>
                    ...
                    <li>
                        <div class="inner">
                            <img src="img/about/company/team-3.jpg" alt="" class="pull-left">
                            <div class="text">
                                <span class="name">John Rukman</span>
                                <span class="position">Founder &amp; Vince President</span>
                                <p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="divider-deco"><span></span></div>
                        Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio
                    ...
                    <div class="col-md-6">
                        <h2>Our Values</h2>
                        <div class="divider-deco"><span></span></div>
                        <p>Benean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio </p>
                        <p>Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio</p>
